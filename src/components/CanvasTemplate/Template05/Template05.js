...
import Styles from "./Template05Styles.module.css";

function Template05(props) {
  return (
    <>
      <div className={Styles["cv-container"]}>
        <div className={Styles["left-side-container"]}>
          ...
          <div
            className={Styles["left-side-heading-container"]}
            style={{ marginTop: "5px", width: "72px" }}
          >
            LANGUAGES
          </div>
          <div
                  ...
                  <React.Fragment key={"education" + index}>
                    <div className={Styles["education-item-container"]}>
                      <div className={Styles["education-school-wrapper"]}>
                        <li className={Styles["li-custom"]}></li>
                        <span style={{ paddingTop: "1px" }}>{edu.school}</span>
                      </div>
