...
import Styles from "./TemplateDownload03Styles.module.css";

function TemplateDownload03(props) {
  return (
    <>
                    ...
                    return (
                      <>
                        <div
                          ...
                          key={"skill" + index}
                        >
                          <li style={{ fontSize: "9px" }}>{skill.name}</li>
...
export default TemplateDownload03;
